# timeless_connoisseur-fashion-luxury - Installation Guide
...
```bash
unzip timeless_connoisseur-fashion-luxury_nextjs.zip
cd timeless_connoisseur-fashion-luxury
```
...
```
timeless_connoisseur-fashion-luxury/
├── public/
├── src/
