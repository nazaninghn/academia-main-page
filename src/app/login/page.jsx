  ...
  return (
    <div className="font-body bg-accent dark:bg-primary text-primary dark:text-accent font-sans antialiased overflow-x-hidden selection:bg-[#B8860B] selection:text-white">
      <>
        ...
        <main className="pt-32 pb-24 flex items-center justify-center min-h-[calc(100vh-200px)]">
          <div className="max-w-md w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white dark:bg-[#2d2d2d] p-8 lg:p-12 shadow-xl border border-primary/5 dark:border-accent/5">
              <h1 className="text-3xl font-serif text-center text-primary dark:text-accent mb-8"> Welcome Back </h1>
              <form className="space-y-6">
                <div>
                  <label htmlFor="email" className="block text-xs uppercase tracking-widest text-primary dark:text-accent mb-2"> Email Address </label>
                  <Input variant="text" className="w-full bg-transparent border-b border-primary/20 dark:border-accent/20 py-2 focus:outline-none focus:border-[#B8860B] transition-colors text-primary dark:text-accent" type="email" placeholder="you@example.com" id="email" />
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    <label htmlFor="password" className="block text-xs uppercase tracking-widest text-primary dark:text-accent"> Password </label>
                    <Link className="text-xs text-primary/50 dark:text-accent/50 hover:text-[#B8860B] transition-colors" href="javascript:void(0)"> Forgot? </Link>
                  </div>
                  <Input variant="text" className="w-full bg-transparent border-b border-primary/20 dark:border-accent/20 py-2 focus:outline-none focus:border-[#B8860B] transition-colors text-primary dark:text-accent" type="password" placeholder="••••••••" id="password" />
                </div>
                <div className="flex items-center">
                  <Input variant="text" className="h-4 w-4 rounded border-gray-300 text-[#B8860B] focus:ring-[#B8860B]" type="checkbox" id="remember-me" name="remember-me" />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-primary/70 dark:text-accent/70"> Remember me </label>
                </div>
                <Button variant="primary" contentKey="cta_9" className="w-full bg-primary dark:bg-accent text-accent dark:text-primary py-4 uppercase tracking-widest text-sm hover:bg-[#B8860B] dark:hover:bg-[#B8860B] dark:hover:text-white transition-colors" type="button"> Sign In </Button>
                <div className="text-center mt-6">
                  <p className="text-sm text-primary/60 dark:text-accent/60">
                     Don't have an account? 
                    <Link className="text-primary dark:text-accent hover:text-[#B8860B] font-medium transition-colors" href="javascript:void(0)"> Create one </Link>
                  </p>
                </div>
              </form>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
              ...
              <div>
                ...
                <form className="flex flex-col space-y-2">
                  ...
                  <Button variant="primary" contentKey="cta_10" className="px-4 py-2 bg-primary dark:bg-accent text-accent dark:text-primary text-sm uppercase tracking-widest hover:bg-[#B8860B] dark:hover:bg-[#B8860B] dark:hover:text-white transition-colors" type="button"> Subscribe </Button>
                </form>
              </div>
            </div>
