          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <article className="prose prose-stone dark:prose-invert max-w-none space-y-12 text-primary/80 dark:text-accent/80 font-light">
              ...
              <section id="1_introduction">
                <h2 className="text-2xl font-serif text-primary dark:text-accent mb-4"> 1. Introduction </h2>
                <p className="leading-relaxed mb-4">
                   Welcome to LUXE ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us. 
                </p>
              ...
              <section id="2_information_we_collect">
                <h2 className="text-2xl font-serif text-primary dark:text-accent mb-4"> 2. Information We Collect </h2>
                <p className="leading-relaxed mb-4">
              ...
              <section id="3_how_we_use_your_information">
                <h2 className="text-2xl font-serif text-primary dark:text-accent mb-4"> 3. How We Use Your Information </h2>
                <p className="leading-relaxed mb-4">
                   We use personal information collected via our website for a variety of business purposes described below. We process your personal information for these purposes in reliance on our legitimate business interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations. 
                </p>
                <p className="leading-relaxed"> We use the information we collect or receive: </p>
              ...
              <section id="4_sharing_your_information">
                <h2 className="text-2xl font-serif text-primary dark:text-accent mb-4"> 4. Sharing Your Information </h2>
                <p className="leading-relaxed">
                   We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations. We may process or share data based on the following legal basis: Consent, Legitimate Interests, Performance of a Contract, or Legal Obligations. 
                </p>
              </section>
              {/* 5 Contact Us */}
              <section id="5_contact_us">
                <h2 className="text-2xl font-serif text-primary dark:text-accent mb-4"> 5. Contact Us </h2>
                <p className="leading-relaxed">
                   If you have questions or comments about this policy, you may email us at 
                  <Link className="text-[#B8860B] hover:underline" href="mailto:privacy@luxe.com"> privacy@luxe.com </Link>
                   or by post to: 
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
              ...
              <div>
                ...
                <form className="flex flex-col space-y-2">
                  ...
                  <Button variant="primary" contentKey="cta_19" className="px-4 py-2 bg-primary dark:bg-accent text-accent dark:text-primary text-sm uppercase tracking-widest hover:bg-[#B8860B] dark:hover:bg-[#B8860B] dark:hover:text-white transition-colors" type="button"> Subscribe </Button>
                </form>
              </div>
            </div>
